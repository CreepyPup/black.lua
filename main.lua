...
local Library = {
	Theme = {
		ThemeColor = Color3.fromRGB(85, 255, 255),
		TopbarColor = Color3.fromRGB(0, 0, 222),
		SidebarColor = Color3.fromRGB(45, 91, 136),
		BackgroundColor = Color3.fromRGB(0, 31, 45),
		SectionColor = Color3.fromRGB(20, 20, 20),
		TextColor = Color3.fromRGB(0, 0, 71),
	},
	Notification = {
		Gui = nil,
		Active = {},
